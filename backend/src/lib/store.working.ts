...
export const RuleSchema = z.object({
  ...
  webhook_ids: z.array(z.number()).min(1, "At least one webhook must be provided"), // Array of webhook IDs for this rule
  enabled: z.boolean().default(true),
  created_at: z.string().optional(),
  updated_at: z.string().optional(),
});

// Rule creation requires webhook_ids
  ...
  private initializeTables() {
    ...
    this.db.exec(`
      CREATE TABLE IF NOT EXISTS rules (
        ...
        webhook_ids TEXT NOT NULL, -- JSON array of webhook IDs
