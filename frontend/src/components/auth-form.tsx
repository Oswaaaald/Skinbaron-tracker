                    ...
                    <div className="grid gap-2">
                      {oauthProviders.includes('google') && (
                        <Button
                          ...
                          className="w-full"
                          disabled={isLoading}
                          onClick={() => { window.location.href = apiClient.getOAuthLoginUrl('google', isLogin ? 'login' : 'register') }}
                        >
                      ...
                      {oauthProviders.includes('github') && (
                        <Button
                          ...
                          className="w-full"
                          disabled={isLoading}
                          onClick={() => { window.location.href = apiClient.getOAuthLoginUrl('github', isLogin ? 'login' : 'register') }}
                        >
                      ...
                      {oauthProviders.includes('discord') && (
                        <Button
                          ...
                          className="w-full"
                          disabled={isLoading}
                          onClick={() => { window.location.href = apiClient.getOAuthLoginUrl('discord', isLogin ? 'login' : 'register') }}
                        >
