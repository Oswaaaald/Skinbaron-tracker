/**
 * Audit and admin log icon/label configurations.
 * Separated from constants.ts to avoid pulling Lucide icons
 * into every file that only needs QUERY_KEYS or polling intervals.
 */
