...
/** Canonical SVG icons for each OAuth provider — import once, use everywhere. */
...
/** Canonical labels for each OAuth provider. */
...
/** Combined metadata: icon + label per provider. */
export const PROVIDER_META: Record<string, { label: string; icon: ReactNode }> = {
  google: { label: PROVIDER_LABELS.google, icon: PROVIDER_ICONS.google },
  github: { label: PROVIDER_LABELS.github, icon: PROVIDER_ICONS.github },
  discord: { label: PROVIDER_LABELS.discord, icon: PROVIDER_ICONS.discord },
};
